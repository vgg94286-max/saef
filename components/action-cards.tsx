...
const actions = [
  ...
  },
  {
    title: "الطلبات",
    description:
    "خدمة تُمكّن الفرسان والحكام والمدربين من إصدار طلبات التفرغ، ورفع طلبات المشاهد، واستخراج خطابات عدم ممانعة رسمية و معتمدة.",
    cta: "اطلب الآن",
    href: "/requests",
    icon: FileText,
  },
  {
    title: "تسجيل الدخول (لموظفي الاتحاد)",
    description:
