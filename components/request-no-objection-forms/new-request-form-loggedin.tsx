...
export function NewLeaveRequestFormLogged( { defaultEmail }: LeaverFormProps) {
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <div className="relative">
                ...
                <Input id="countryName" placeholder="اسم الدولة" {...register("countryName")} className="pr-10 text-left placeholder:text-right uppercase" dir="ltr" />
              </div>
