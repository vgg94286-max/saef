    ...
    try {
        ...
        const emailHtml = `
            <div dir="rtl" style="font-family: sans-serif; text-align: right; line-height: 1.6;">
                ...
                <p>نحيطكم علماً بأنه تمت <strong>الموافقة</strong> على طلب التفرغ الخاص بكم.</p>
        ...
        if (result.email) {
            sendPulseEmail({
                to: result.email,
                subject: "الموافقة على طلب التفرغ - الاتحاد السعودي للفروسية والبولو",
                html: emailHtml,
            });
        }
